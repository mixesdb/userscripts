...
// @require      https://raw.githubusercontent.com/mixesdb/userscripts/refs/heads/main/includes/global.js?v-SoundCloud_29
// @require      https://raw.githubusercontent.com/mixesdb/userscripts/refs/heads/main/includes/toolkit.js?v-SoundCloud_42
                        ...
                        success: function( t ) {
                            ...
                            if( kind == "track" ) {
                                ...
                                waitForKeyElements("#mdb-toolkit > ul", function( jNode ) {                                    
                                    ...
                                    apiQueryUrl_check += "&url=" + t.permalink_url;
                                        ...
                                        success: function(data) {
                                            ...
                                            if( ( data.error && data.error.code == "notfound" )  ) {
                                                ...
                                                if( lastCheckedAgainstMixesDB ) {
                                                    li_tidLink_out += ' <span id="mdbTrackidCheck-wrapper" class="integrated">'+checkIcon+'integrated';
                                                    li_tidLink_out += ' ' + toolkit_tidLastCheckedText( lastCheckedAgainstMixesDB ) + '</span>';
                                                } else {
