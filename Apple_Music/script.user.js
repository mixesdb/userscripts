...
// @updateURL    https://raw.githubusercontent.com/mixesdb/userscripts/refs/heads/main/Apple_Music/script.user.js
...
// @require      https://raw.githubusercontent.com/mixesdb/userscripts/refs/heads/main/shared/global.js?v-Apple_Music_10
// @require      https://raw.githubusercontent.com/mixesdb/userscripts/refs/heads/main/shared/tracklist_editor/funcs.js?v-Apple_Music_14
// @match        https://*music.apple.com/*
// @match        https://*beta.music.apple.com/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=music.apple.com
// @resource     IMPORTED_CSS_1 https://raw.githubusercontent.com/mixesdb/userscripts/refs/heads/main/shared/global.css?v-Apple_Music_4
// @resource     IMPORTED_CSS_2 https://raw.githubusercontent.com/mixesdb/userscripts/refs/heads/main/shared/tracklist_editor/tracklistEditor_copy.css
...
/*
 * Apple Music never loads a document once it is running, so this is the whole per-page job
 * and onUrlChange() (global.js) calls it again for every album/playlist the user clicks.
 * It also takes the previous album's #mdb-tl-fakeOutput off the page, which used to need a
 * manual .remove() here.
 *
 * This replaces two mechanisms at once: redirectOnUrlChange() for most browsers, and a
 * hand-written location poll for Safari, which was needed because parts of Apple Music run
 * in an iframe whose own URL is a fetch-proxy - reloading THAT is not what anyone wanted.
 * Not reloading at all makes the distinction pointless: every frame just re-runs its own work.
 */
function runAppleMusicPage() {
    setTimeout(function() {
...
onUrlChange( runAppleMusicPage, { runNow: true } );
