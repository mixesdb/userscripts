...
var timeoutDelay = 600,
    ta = '<div id="tlEditor"><textarea id="mdb-TLbox" class="mono" style="display:none; width:100%; margin:10px 0 0 0;"></textarea></div>',
...
// select elements
waitForKeyElements(".mdb-element.select", mdbElement_select);
function mdbElement_select(jNode) {
    jNode.select().focus();
}
 ...
 */
// waitForKeyElements
waitForKeyElements(".mdb-tid-table:not('.tlEditor-processed')", waitTracklist);
